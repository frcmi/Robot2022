...
public class AutonomousPlanC extends SequentialCommandGroup {
  ...
  public AutonomousPlanC(DriveTrain drive, Intake intake, Feed feed, Shooter shooter) {
    ...
    addCommands(new ParallelRaceGroup(new SetShooter(shooter), new SequentialCommandGroup(new DriveFromFender(drive), new WaitCommand(1), new AutonomousFeed(2, feed), new DriveOutOfTarmac(drive))));
  }
}
